...
# file names used
normal_file_name = os.getcwd() + '/Dataset/normal_tweet_id.txt'
sarcastic_file_name = os.getcwd() + '/Dataset/sarcastic_tweet_id.txt'
data_set_file_name = os.getcwd()+ '/Dataset/dataset.csv'
